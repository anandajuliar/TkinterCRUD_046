...
# Element GUI
Label(root, text="Nama Siswa", bg="#C6E7FF").grid(row=0, column=0, padx=10, pady=5)
Entry(root, textvariable=nama_var).grid(row=0, column=1, padx=10, pady=5)

Label(root, text="Biologi", bg="#C6E7FF").grid(row=1, column=0, padx=10, pady=5)
Entry(root, textvariable=biologi_var).grid(row=1, column=1, padx=10, pady=5)

Label(root, text="Fisika", bg="#C6E7FF").grid(row=2, column=0, padx=10, pady=5)
Entry(root, textvariable=fisika_var).grid(row=2, column=1, padx=10, pady=5)

Label(root, text="Bahasa Inggris", bg="#C6E7FF").grid(row=3, column=0, padx=10, pady=5)
